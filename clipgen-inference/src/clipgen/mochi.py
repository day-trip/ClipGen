...
class MochiModel(ModelInterface):
    def __init__(self):
        ...
        self.shards_dir = Path("/tmp/mochi_models/shards")
    ...
    async def initialize(self, gpu_devices: list[int]) -> None:
        ...
        if USE_MULTI_GPU:
            from genmo.mochi.pipelines import DecoderModelFactory, DitModelFactory
            from genmo.mochi.patch.encoder import BetterT5ModelFactory
            from genmo.mochi.patch.pipeline import MochiDualGPUPipeline
            from genmo.mochi.patch.dit import PreshardedDitModelFactory
            ...
            from genmo.mochi.pipelines import (
    ...
    async def generate(self, input_data: Dict[str, Any]) -> Path:
        ...
        from genmo.mochi.pipelines import linear_quadratic_schedule
